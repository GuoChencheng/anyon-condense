...
def _policy_snapshot(policy: NumericPolicy) -> Dict[str, Any]:
    ...
    subset = {
        ...
        "round_half": snap.get("round_half"),
        "array_reorder": snap.get("array_reorder"),
        "clip_small": snap.get("clip_small"),
        "mode": snap.get("mode", "float"),
    }
    return subset
